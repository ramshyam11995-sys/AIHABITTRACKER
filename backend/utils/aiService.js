...
export const chatCompletion = async ({
    ...
    if (!c) {
        return {
            ok: false,
            content:
                "AI features are disabled. Please set GEMINI_API_KEY in the backend .env file to enable real AI responses.",
        };
    }
