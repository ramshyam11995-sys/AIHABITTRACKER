...
const EMAIL = "marse@gmail.com";
const PASSWORD = "passwordmarse";
const NAME = "Marse Omani";
...
const HABITS = [
    ...
    {
        name: "Journal",
        description: "Write 3 things I's grateful for.",
        category: "Mindfulness",
        frequency: "daily",
        targetDays: 5,
        color: "#ec4899",
...
const run = async () => {
    ...
    if (user) {
        console.log(`Found existing user $(EMAIL) - clearing their date...`);
