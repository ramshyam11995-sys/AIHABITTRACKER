...
import AIHabitHealth from "../components/AIHabitHealth.jsx";
import AIHabitCoach from "../components/AIHabitCoach.jsx";
...
const REPORT_CACHE_KEY = (weekStart) =>
...
export default function Insights() {
  ...
  return (
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid lg:grid-cols-[0.8fr_1.7fr] gap-5">
        ...
        <div className="space-y-5">
          ...
          <div className="card p-5 relative overflow-hidden">
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at 100% 0%, rgba(245,158,11,0.14), transparent 60%)",
              }}
            />
            ...
            <div className="relative">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-muted mt-0.5">
                    What's moving your week forward
                  </div>
              ...
              <div className="mt-3 rounded-xl bg-brand-500/10 p-3">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-soft leading-relaxed">
                    ...
                    Keep your strongest habit
                    consistent while giving
                    your weakest habit one small
              ...
              ({
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-sm mb-1">
                    ...
                    <span className="text-muted text-xs ml-2 shrink-0">
